                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                    ...
                                    <div class="m-t-20">
                                        <form class="" method="post" action="{{ route('equipotrabajo.cropsend', $equipo->id) }}" >
                                        {!! method_field('PUT') !!}
                                        {!! csrf_field() !!}

                                            
                                            <div class="form-group" style="width:470px" >
                                               <img width="450" height="363" id="t3soeta2" class="img-fluid mx-auto" src="{{ Storage::url($portafolio->foto) }}" alt="">
                                            </div>
